...
1. Clone the Aryacoin Core source code:
...
2.  Build Aryacoin Core:
    ...
    Configure and build the headless Aryacoin Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/aryacoin/src
        cp aryacoind /usr/local/bin/
        cp aryacoin-cli /usr/local/bin/

Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Aryacoin Core may be compiled in
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Aryacoin"

    touch "/Users/${USER}/Library/Application Support/Aryacoin/aryacoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Aryacoin/aryacoin.conf"

The first time you run aryacoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
