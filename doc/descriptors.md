# Support for Output Descriptors in Aryacoin Core

Since Aryacoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `aya1...` for mainnet or `taya1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Aryacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Aryacoin Core wallets, a convenience function `combo` is
