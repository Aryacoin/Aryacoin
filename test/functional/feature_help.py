...
"""Verify that starting aryacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aryacoin with -h for help text")
        ...
        self.log.info("Start aryacoin with -version for version information")
        ...
        self.log.info("Start aryacoind with -fakearg to make sure it does not start")
