...
class ImportMultiTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses = [
            'raya1qtmp74ayg7p24uslctssvjm06q5phz4yrc3zpyj', # m/0'/0'/0
            'raya1q8vprchan07gzagd5e6v9wd7azyucksq2c4ynpe', # m/0'/0'/1
            'raya1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjlg94gz', # m/0'/0'/2
            'raya1qau64272ymawq26t90md6an0ps99qkrse22pnz3', # m/0'/0'/3
            'raya1qsg97266hrh6cpmutqen8s4s962aryy77vv4ql3', # m/0'/0'/4
        ]
        result = wrpc.importmulti(
            [{
