...
class DeriveaddressesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        address = "raya1qjqmxmkpmxt80xz4y3746zgt0q3u3ferr0c8362"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["raya1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqtc0r66", "raya1qpgptk2gvshyl0s9lqshsmx932l9ccsv2ye3927"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "raya1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqtc0r66", "raya1qpgptk2gvshyl0s9lqshsmx932l9ccsv2ye3927"])
