...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aryacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aryacoin-tx [options] <hex-tx> [commands]  Update hex-encoded aryacoin transaction\n" +
            "or:     aryacoin-tx [options] -create [commands]   Create hex-encoded aryacoin transaction\n" +
            "\n";
