...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s aryacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  aryacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aryacoin transaction") + "\n" +
              "  aryacoin-tx [options] -create [commands]   " + _("Create hex-encoded aryacoin transaction") + "\n" +
              "\n";
