...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Aryacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"54.39.99.167", "54.39.99.167"},
    {"54.39.99.180", "54.39.99.180"},
    {"54.39.99.181", "54.39.99.181"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Aryacoin is probably already running."), addrBind.ToString().c_str());
        else
