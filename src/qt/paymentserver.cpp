...
const QString BITCOIN_IPC_PREFIX("aryacoin:");
#ifdef ENABLE_BIP70
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/aryacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/aryacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/aryacoin-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start aryacoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("aryacoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'aryacoin://' is not a valid URI. Use 'aryacoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Aryacoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
