This directory contains the AryacoinQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the Aryacoin UI.
...
Used to process BIP21 and BIP70 (see https://github.com/bitcoin/bitcoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a aryacoin:... link from a browser).
...
10. Start debugging with Qt Creator (you might need to the executable to "aryacoin-qt" under "Run", which is where you can also add command line arguments)
