...
bech32_templates = [
  ...
  ('aya',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('aya',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('aya',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('taya',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('taya',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('taya',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('raya',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('raya',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('raya', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('taya',  17, 32, False, False, False),
  ('raya',  3,  1, False, False, False),
  ('aya',   15, 41, False, False, False),
  ('taya',  0, 16, False, False, False),
  ('raya',  0, 32, True,  False, False),
  ('aya',   0, 16, True,  False, False),
  ('taya',  0, 32, False, True,  False),
  ('raya',  0, 20, False, False, True)
]
